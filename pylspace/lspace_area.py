...
class LSpaceArea (RustObject):
	...
	__new_lspace_area = RustMethod('LSpaceArea*', 'new_lspace_area',
				       [])
	__lspace_area_set_content_pres = RustMethod('void', 'lspace_area_set_content_pres',
					      ['LSpaceArea *area', 'Pres *content'])
	...
	def __init__(self):
		super(LSpaceArea, self).__init__(self.__new_lspace_area.invoke())

	def set_content_pres(self, content):
		self.__lspace_area_set_content_pres.invoke(self, content)
